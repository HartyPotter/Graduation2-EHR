...
import { deleteRecordSchema, getRecordSchema } from '../../validators/schemas/index.js';
...
export default [
  ...
  return sendSuccess(res, message = 'Medical record deleted successfully', statusCode = 204);
})
];