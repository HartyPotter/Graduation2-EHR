// AUTH
export { default as register } from './doctor/register.js'
export { default as login } from './doctor/login.js'
...
export { default as forgotPassword } from './doctor/forgot-password.js'
