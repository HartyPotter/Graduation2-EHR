...
const { DB_URI, PORT, JWT_ACCESS_SECRET_KEY, JWT_REFRESH_SECRET_KEY, JWT_RESET_SECRET_KEY, APP_MAIL, APP_MAIL_KEY, REDIS_HOST, REDIS_PORT, REDIS_PASS } = process.env
